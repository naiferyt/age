...
export const TableHeader: React.FC<React.HTMLAttributes<HTMLTableSectionElement>> = ({
  ...
  return (
    <thead
      className={cn("border-b border-slate-200 bg-slate-50/80 text-xs text-slate-500 uppercase tracking-wider", className)}
      {...props}
    >
      {children}
    </thead>
...
export const TableRow: React.FC<React.HTMLAttributes<HTMLTableRowElement>> = ({
  ...
  return (
    <tr
      className={cn("hover:bg-slate-50/70 transition-colors group", className)}
      {...props}
    >
      {children}
    </tr>
